...
The distribution of normalized singular values of the Jacobian of a function drawn from a 5-dimensional deep \gp{} prior 2 layers deep~(\emph{Left}) and 6 layers deep~(\emph{Right}).
