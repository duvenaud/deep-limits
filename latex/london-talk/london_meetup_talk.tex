...
%	\item Closely related to constructing priors
	\item Experiments are hard.
	\item We'll sample from priors on deep nets to help understand them without reference to a specific dataset, loss function, or training method.
