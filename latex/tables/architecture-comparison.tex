...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    % Annotate the layers
    \node[annot,above of=H-1, node distance=1cm] (hl) {Hidden};
...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    % Annotate the layers
    \node[annot,above of=H-1, node distance=1cm] (hl) {Hidden};
    \node[annot,above of=H2-1, node distance=1cm] (hl2) {Hidden};    
    \node[annot,left of=hl] {Input};
...
\end{tikzpicture} \\
Single-layer NN, or \gp{}& 2-Hidden layer NN & Two-layer deep \gp{} model: $\vy = f_2(f_1(\vx))$
\end{tabular}
