...
%\begin{itemize}
%\item A good latent representation is invariant in directions orthogonal to the manifold on which the data lie.  
...
\item This mixture has closed-form covariance
\end{itemize}
\end{minipage}
&
