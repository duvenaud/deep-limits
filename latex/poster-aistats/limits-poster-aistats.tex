...
\mysection{Let's Examine Priors on Deep Neural Networks}
...
\hspace{-0.5in} \hspace{-0.05in}\includegraphics[width=0.24\columnwidth]{../../figures/seed-0-map-connected/layer_0} & \mappiccon{2} & \mappiccon{10} & \mappiccon{40}
