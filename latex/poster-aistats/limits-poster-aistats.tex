...
\item Dropping out inputs gives mixture of \gp{}s, with closed-form covariance: $$\covarianceargs{}{f(\vx'), f(\vx)} = \frac{1}{2^D} \sum_{\vr \in \{0,1\}^D}  \prod_{d=1}^D k_d(\vx_d, \vx_d')^{r_d}$$
\end{itemize}
\end{minipage}
&
