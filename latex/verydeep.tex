...
\newcommand{\mappic}[1]{\includegraphics[width=0.3\columnwidth, clip, trim = 1.5cm 1.5cm 1.5cm 1.5cm]{figures/map/latent_coord_map_layer_#1}}  % airline results dir
...
\newcommand{\mappiccon}[1]{\includegraphics[width=0.3\columnwidth, clip, trim = 1.5cm 1.5cm 1.5cm 1.5cm]{figures/map_connected/latent_coord_map_layer_#1}}  % airline results dir
...
$k_1(x,y) = e^{-||x - y||2}$, then the two-layer kernel is simply $k_2(x,y) = e^{k_1(x, y) - 1}$.  For this blog post, I re-derived this result found that his formula was true for every layer: $k_{n+1}(x,y) = e^{k_n(x, y) - 1}$.
