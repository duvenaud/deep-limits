...
Choosing appropriate architectures and initialization strategies is crucial to good performance of deep networks.  To shed light on this problem, we analyze the analogous problem of constructing useful priors on compositions of functions.
...
a) A noise-tolerant representation (blue \& green) & b) A na\"{i}ve representation (colors) \\
...
\gpdrawboxcon{5} \\
 ...
 \end{tabular} &
\begin{tabular}{c}
\includegraphics[trim=2mm 0mm 2mm 0.5mm, clip, width=0.315\columnwidth]{figures/spectrum/con-layer-50} \\
%\gpdrawboxcon{6} \\
