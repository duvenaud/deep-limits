...
\aistatsauthor{ David Duvenaud \And Oren Rippel \And Ryan P. Adams \And Zoubin Ghahramani }
\aistatsaddress{ 
...
\newcommand{\mappic}[1]{\hspace{-0.05in}\includegraphics[width=0.465\columnwidth]{figures/map/latent_coord_map_layer_#1}} 
\newcommand{\mappiccon}[1]{\hspace{-0.05in} \includegraphics[width=0.465\columnwidth]{figures/map_connected/latent_coord_map_layer_#1}}
\begin{figure}[h!]
\centering
\begin{tabular}{cc}
...
We thank Carl Rasmussen, Andrew McHutchon, Neil Lawrence, Andreas Damianou, James Lloyd, Creighton Heaukulani, Dan Roy, Mark van der Wilk, Miguel Hern\'{a}ndez-Lobato and Andrew Tulloch for helpful discussions.
