...
\begin{itemize}
\item Deep \gp{}s can be viewed as \MLP{}s with a finite number of hidden units, each having a different nonparametric activation function, or as an infinitely-wide \MLP{} with low-rank connectivity matrices.
